...
# управление осями
INVERT_X     = False              # True = инвертировать ось X
INVERT_Y     = False              # True = инвертировать ось Y
...
try:
    while True:
        ...
        target_for_error, ref_point = None, None
        if obj is not None and laser is not None:
            target_for_error, ref_point = obj, laser
            last_seen = time.time()
            auto_centered = False
        elif obj is not None:
            target_for_error, ref_point = obj, frame_center
            last_seen = time.time()
            auto_centered = False
